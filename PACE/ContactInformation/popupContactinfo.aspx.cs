...
public partial class ContactInformation_popupContactinfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                CommonMethods.InsertingPageInfo("I", UserUID, "PopUpContactInfo.aspx");
                //get data table and checking is it dataset 
                ContactInfoBAL contactInfoBAL = new ContactInfoBAL();
                ds = contactInfoBAL.GetContactInfoPopUp(UserUID);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int i = 0;
            i = contactInfoBAL.SaveContactInfoPopUp(contactInfo, UserUID, "SU");
            if (i > 0)
            {
