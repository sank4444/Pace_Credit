...
{
    public partial class MemberListing_cr : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                CommonMethods.InsertingPageInfo_cr("I", Convert.ToString(UserUID), "MemberListing_cr.aspx");
                _objConfigurationBAL = new _objConfigurationBAL();
                dtPolicyYear = _objConfigurationBAL.GetPolicyYear_cr(UserUID, "POLICYYEAR");
            ...
            try
            {
                ...
                if (ds != null)
                {
                    ...
                    else
                    {
                        ...
                        MenuMasterPage_Cr.ShowNoResultFound(ds.Tables[0], gvMemberList);
                    }
                }
            }
            catch (Exception ex)
