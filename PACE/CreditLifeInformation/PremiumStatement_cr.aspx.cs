...
{
    public partial class PremiumStatement_cr : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                CommonMethods.InsertingPageInfo_cr("I", Convert.ToString(UserUID), "PremiumStatement_cr.aspx");
            }
        }
        private void BindPremiumState(string XML)
        {
            try
            {
                ...
                dsResult = reports.GetPremiumStatement_cr(Convert.ToInt32(UserUID), XML);
                if (dsResult != null)
                {
