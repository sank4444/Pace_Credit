<%@ Page Language="C#" AutoEventWireup="true" Inherits="NEL" CodeBehind="NEL.aspx.cs" %>
                        ...
                        <td>
                            <div style="width: 50%;">
                                <asp:GridView ID="gvMedicalNonMedical" runat="server" OnRowCommand="gvMedicalNonMedical_RowCommand"
                                    AllowPaging="true" PageSize="5" Width="100%" AutoGenerateColumns="true" OnPageIndexChanging="gvMedicalNonMedical_PageIndexChanging">
                    ...
                    <tr>
                        <td>
                            <p>
                                ...
                                above mentioned NEL may not be applicable to all members. Kindly refer to policy
                                quotation for further details.</p>
                        </td>
                    </tr>
                </table>
