<%@ Page Language="C#" AutoEventWireup="true" Inherits="ContactInformation_popupContactinfo"
    CodeBehind="popupContactinfo.aspx.cs" %>
                        ...
                        <td style="width: 100%; margin: 5px">
                            <table width="100%" cellpadding="5" cellspacing="5" border="0" style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <input id="txtAddress" runat="server" type="text" style="width: 90%; height: 25px; padding-left:5px;
                                            border-radius: 10px;" disabled="True"  />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtContPerName" runat="server" CssClass="inputbg" 
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtContactNo" runat="server" CssClass="inputbg" 
                                            Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="inputbg" Enabled="False"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <asp:Button ID="btnEdit" runat="server" CssClass="edit_button" 
                                            onclick="btnEdit_Click"  />
                                        <asp:Button ID="btnSave" runat="server" CssClass="save_button" 
