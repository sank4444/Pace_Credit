...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:MultiView ID="MV_UploadSR_View" runat="server" ActiveViewIndex="0">
                        ...
                        <div>
                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlServicingChange" runat="server" CssClass="styled-select"
            ...
            <table cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: left; width: 100%;">
                        <div style="width: 980px; height: 450px; overflow: scroll;">
                            <asp:GridView ID="grdExcelUploadedData" runat="server">
        ...
        <asp:View ID="View_ShowLog" runat="server">
            <table cellspacing="0" style="width: 100%;" border="0">
                ...
                <%--End--%>
                <tr>
                    <td style="text-align: left; width: 980px; padding-left: 12px;">
                        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" Width="980px" ActiveTabIndex="3"
                            ...
                            <ajaxToolkit:TabPanel ID="pnlErrorLog" runat="server" HeaderText="Success" BackColor="#22bcb9"
                                ...
                                <ContentTemplate>
                                    <div style="width: 980px; height: 450px; overflow: auto;">
                                        <asp:GridView ID="grdConform" runat="server" Visible=false>
                                            <PagerSettings PreviousPageText="Previous" FirstPageText="<" LastPageText=">" Mode="NextPreviousFirstLast"
                                                NextPageText="Next" />
                                            <FooterStyle CssClass="GridViewFooterStyle" />
                                            <RowStyle CssClass="GridViewRowStyle" />
                            ...
                            <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="Error" BackColor="#22bcb9"
                                ...
                                <ContentTemplate>
                                    <div style="width: 980px; height: 421px; overflow: auto;">
                            ...
                            <ajaxToolkit:TabPanel ID="TabPanel3" runat="server" HeaderText="AAW" BackColor="#22bcb9"
                                Visible="false" BorderColor="#22bc9">
                                <ContentTemplate>
                                    <div style="width: 980px; height: 421px; overflow: auto;" style="border: none !important">
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:LinkButton ID="BillGenerationPdf" runat="server" Text="View" CommandName="view"
                                                ToolTip="Download" CommandArgument='<%#Eval("BillUID") %>' Font-Strikeout="false"
                                                Font-Italic="false" Font-Underline="false"></asp:LinkButton>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <FooterStyle CssClass="GridViewFooterStyle" />
    ...
    <script type="text/javascript">
        ...
        //        function BeginProcess(Message) {
        //            // Create an iframe.
        //            var iframe = document.createElement("iframe");

        //            // Point the iframe to the location of
        //            //  the long running process.
        //            iframe.src = "LongRunningProcess.aspx?" + Message;
        ...
        //            document.getElementById('divDisplay').innerHTML = Message;
