                    ...
                    <li class="nav-item has-megamenu">
                        ...
                        <div class="mega-menu">
                            ...
                            <div class="mega-menu-column">
                                <h4>Downloads</h4>
                                <ul>
                                    <li><a href="premium_rates.html" class="nav-link sub-link">Premium Rates Credit Life</a></li>
                                    <li><a href="nel.html" class="nav-link sub-link">Non Medical Limit (NML)</a></li>
                                    <li><a href="benefit_basis.html" class="nav-link sub-link">COI Download</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item has-megamenu">
                        ...
                        <div class="mega-menu">
                             <div class="mega-menu-column">
                                <h4>Calculation</h4>
                                <ul>
                                    <li><a href="bill_enquiry.html" class="nav-link sub-link">Premium calculator</a></li>
                                    <li><a href="bill_payment.html" class="nav-link sub-link">Surrender calculator</a></li> <!-- Updated link -->
                                </ul>
                            </div>
                        </div>
                    </li>
