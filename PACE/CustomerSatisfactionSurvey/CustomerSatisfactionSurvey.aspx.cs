...
public partial class CustomerSatisfactionSurvey_CustomerSatisfactionSurvey : System.Web.UI.Page
{
    int UserUID = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            CommonMethods.InsertingPageInfo("I", Convert.ToString(UserUID), "CustomerSatisfactionSurvey.aspx");
    ...
    protected void btnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            int Result = obj.UpdateCustomerSatisfactionSurvey(objCustomerSatisfactionSurveyInfo, UserUID);
            if (Result >= 0)
            {
                txtDescription.Text = "";
