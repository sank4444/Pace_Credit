...
public partial class Masters_MenuMasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session[CommonConstantNames.USERUID] != null && Session["AuthToken"] != null && Request.Cookies["AuthToken"] != null)
        {
            ...
            {
                BillEnquiry.Visible = false;
                divPolicyInfo.Visible = false;
            ...
            {
                DataTable dtBanner = CommonMethods.DisplayMessageForBanner(Session[CommonConstantNames.USERUID].ToString());
                lblmarquee.InnerText = dtBanner.Rows.Count > 0 ? dtBanner.Rows[0]["MessageDisplay"].ToString() : "GOOD PROTECTS EVERYTHING THAT\'S GOOD IN LIFE";
