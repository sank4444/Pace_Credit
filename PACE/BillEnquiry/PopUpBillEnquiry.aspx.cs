...
public partial class BillEnquiry_PopUpBillEnquiry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                CommonMethods.InsertingPageInfo("I",Convert.ToString(UserUID), "PopUpBillEnquiry.aspx");
                ...
                try
                {
                    ...
                    dsMemberWiseBillingDetails = objBillEnquiryBAL.GetPopUpBillEnquiry(billNo, UserUID);
