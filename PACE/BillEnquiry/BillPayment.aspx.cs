...
namespace PACE.BillEnquiry
{
    public partial class BillPayment : System.Web.UI.Page
    {
        ...
        */
            ...
            if (!IsPostBack)
            {
                CommonMethods.InsertingPageInfo("I", UserUID, "BillPayment.aspx");
        ...
        private void GetBillPayMent(string ToDate, string FromDate)
        {
            try
            {
                ...
                dsBillPayment = objBillEnquiryBAL.GetBillPayMent(UserUID, convToDate, convFromDate, ACTION);
                ...
                if (dsBillPayment != null)
                {
                    ...
                    {
                        Masters_MenuMasterPage.ShowNoResultFound(dsBillPayment.Tables[0], gvBillPayment);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void GetFloat()
        {
            try
            {
                ...
                dsFloat = objBillEnquiryBAL.GetFloat(UserUID, ACTION);
        ...
        protected void imgPay_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                int Error = 0;
                Error = objBillEnquiryBAL.InsertBillPayment(UserUID, XML, "");
                if (Error > 0)
                {
