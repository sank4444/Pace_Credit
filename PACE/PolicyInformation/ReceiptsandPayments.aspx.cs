...
{
    public partial class ReceiptsandPayments : System.Web.UI.Page
    {
        ...
        private void FillDropDown()
        {
            ...
            try
            {
                ddlSelection.DataSource = objPolicyInformationBAL.GetReceiptsandPaymentsDDL(UserUID, "RP");
        ...
        protected void BindingGrid(string ACTION)
        {
            ...
            try
            {
                ...
                if (ds != null)
                {
                    ...
                    {
                        Masters_MenuMasterPage.ShowNoResultFound(ds.Tables[0], gvReceiptPaymnet);
