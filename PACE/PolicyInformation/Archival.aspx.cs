...
{
    public partial class Archival : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    CommonMethods.InsertingPageInfo("I", Convert.ToString(UserUID), "Archival.aspx");
                    _objConfigurationBAL = new _objConfigurationBAL();
                    dtPolicyYear = _objConfigurationBAL.GetPolicyYear(UserUID, "POLICYYEARARCHIVAL");
        ...
        protected void ddlPolicyYear_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Masters_MenuMasterPage.ShowNoResultFound(dt, gvArchival);
                }
            }
            catch (Exception ex)
            {
