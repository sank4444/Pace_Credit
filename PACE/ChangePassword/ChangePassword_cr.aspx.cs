...
{
    public partial class ChangePassword_cr : System.Web.UI.Page
    {
        string userUID = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                CommonMethods.InsertingPageInfo_cr("I", userUID, "ChangePassword_cr.aspx");
            }
                ...
                if (Session["CaptchaImageText"] != null)
                {
                    ...
                    if (this.TxtCaptchaCode.Text == this.Session["CaptchaImageText"].ToString())
                    {
                        ...
                        if (isChanged.ToLower() == "true")
                        {
                            ...
                            DataSet ds = loginCredentialBAL.CHANGEPASSWORD_cr(txtNewPassword.Text, txtOldPassword.Text, sUserUID);
