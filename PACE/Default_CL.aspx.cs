...
namespace PACE
{
    public partial class Default_CL : System.Web.UI.Page
    {
        
        protected void Page_PreInit(object sender, EventArgs e)
        {
           //shinagi TTSLInput.Value = Session["IsTTSL"].ToString();
        }
        ...
        {
            CommonMethods.InsertingPageInfo_cr("I", Convert.ToString(Session[CommonConstantNames.USERUID]), "Logout.aspx");
